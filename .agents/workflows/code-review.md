...
1. **Project rules** — Read `CLAUDE.md`, `.agents/docs/`, and any contributing guidelines
2. **Planning artifacts** — Check `.agents/prds/`, `.agents/plans/`, `.agents/reviews/`, and legacy `.agents/PRPs/{prds,plans,reports,reviews}/` for context related to this PR
...
Create review artifact at `.agents/reviews/pr-<NUMBER>-review.md` unless the repo already uses legacy `.agents/PRPs/reviews/` for this workstream:
...
Artifacts:
  Review: .agents/reviews/pr-<NUMBER>-review.md
  GitHub: <PR URL>
